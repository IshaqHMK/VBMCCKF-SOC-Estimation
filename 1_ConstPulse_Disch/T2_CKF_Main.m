...
Q =  diag([1e-2 1e-2 1e-2]);      % Process Noise covariance
R =  4e-4;                        % Measurement Noise Covariance
...
CKF_MAEPercentage = mean(abs(xEstimate-xTruth))*100
